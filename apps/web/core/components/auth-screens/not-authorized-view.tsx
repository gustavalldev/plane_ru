    ...
    <DefaultLayout className={cn("bg-surface-1", className)}>
      <div className="flex h-full w-full flex-col items-center justify-center gap-y-5 text-center">
        <div className="h-44 w-72">
          <img src={asset} className="h-[176px] w-[288px] object-contain" alt="Нет доступа" />
        </div>
        <h1 className="text-18 font-medium text-primary">У вас нет доступа к этой странице</h1>
        {actionButton}
      </div>
    </DefaultLayout>
  );
