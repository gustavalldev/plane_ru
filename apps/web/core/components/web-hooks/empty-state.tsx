  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-center text-center">
        <img src={EmptyWebhook} className="w-52 object-cover sm:w-60" alt="Пустой список вебхуков" />
        <h6 className="mt-6 mb-3 text-18 font-semibold sm:mt-8">Вебхуков пока нет</h6>
        <p className="mb-7 text-tertiary sm:mb-8">Создайте вебхуки, чтобы получать события в реальном времени и автоматизировать действия</p>
